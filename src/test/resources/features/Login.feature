Feature: Login
  ...
  # Any step was implemented before, can be reused
  # If test step has yellow backround, that means it doesn't have implementation yet
  ...
  # In my project, I was trying to keep scenarios short ==> he said.
